...
function App() {
  ...
  return (
    ...
    <main>
      <header>
        <img src="https://m.media-amazon.com/images/G/31/social_share/amazon_logo._CB633266945_.png"  alt="" style={{width:'30px',height:'20px',margin:'10px'}} />
        <a href="">Home</a>
      ...
      <footer>
        <p>Copyright Reseverd by ABES Enginnering College</p>
      </footer>
    </main>
    </>
  )
